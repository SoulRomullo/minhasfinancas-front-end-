                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <br />
                            <FormGroup htmlForm="inputMes" label="Mês: ">
                            ...
                            <br />
                            <FormGroup htmlForm="inputDesc" label="Descrição: ">
                            ...
                            <br />
                            <FormGroup htmlForm="inputTipo" label="Tipo de Lançamento: ">
                    ...
                    <div className="col-md-12">
                        <div className="bs-component">
                            <LancamentosTable lancamentos={this.state.lancamentos}
                                ...
                                alterarStatus={this.state.alterarStatus}
                            />
                        </div>
                    </div>
                </div>
